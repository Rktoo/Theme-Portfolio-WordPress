...
<footer class="bg-gradient-to-r from-blue-500 to-teal-500 text-white">
    ...
    <div class="fixed bottom-10 right-[10%] opacity-0  " id="scroll-btn">
        <a href="#" class="relative group w-8 h-8 opacity-75 hover:opacity-100 transition-opacity duration-150 ease-in-out animate-pulse hover:animate-none active:animate-none z-30 overflow-hidden">
