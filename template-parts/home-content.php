...
<div class="w-full grid grid-cols-1 space-y-10 space-x-5 md:grid-cols-3 justify-between items-center">
    <div class="col-span-2 flex flex-col justify-start items-start -mt-28">
    ...
    <div class="col-span-1 w-full flex justify-center items-start -mt-44">
        <div class=" w-64 h-64 rounded-full bg-[#f4f4f4] overflow-hidden">
            <img src="<?php echo get_theme_mod('hero_image'); ?>" alt="Image de bannière" class="w-64 h-64 ">
        </div>
    </div>
</div>